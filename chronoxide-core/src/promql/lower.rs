...
use super::{METRIC_NAME_LABEL, ast::*, normalize::normalize_label_name};

pub(super) fn lower_expr(expr: &parser_promql::Expr) -> Result<PromqlQuery, PromqlQueryError> {
    match expr {
...
pub(super) fn lower_vector_selector(
