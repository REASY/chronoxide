...
impl SegmentStoreReader {
    pub(in crate::storage::segment) fn execute_promql_query_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
        query: &PromqlQuery,
    ...
    pub(super) fn execute_promql_instant_query_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
        query: &PromqlQuery,
    ...
    pub(super) fn execute_promql_float_only_instant_query_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
        query: &PromqlQuery,
    ...
    pub(super) fn execute_promql_histogram_fraction_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
    ...
    pub(super) fn execute_promql_histogram_quantile_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
    ...
    pub(super) fn execute_promql_histogram_scalar_function_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
    ...
    pub(super) fn execute_promql_native_histogram_scalar_aggregation_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
    ...
    pub(super) fn execute_promql_native_histogram_binary_bool_comparison_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
    ...
    pub(super) fn execute_promql_scalar_operand_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
        query: &PromqlQuery,
    ...
    pub(super) fn execute_promql_binary_expression_with_head<R>(
        &self,
        head: &HeadBuffer,
        labels: &R,
        expression: &PromqlBinaryExpression,
