...
pub(super) fn evaluate_native_histogram_combined_vector_set(
    expression: &PromqlBinaryExpression,
...
pub(super) fn evaluate_native_exponential_histogram_combined_vector_set(
    expression: &PromqlBinaryExpression,
    left_exponential_series: Vec<PromqlExponentialHistogramSeries>,
    right_exponential_series: Vec<PromqlExponentialHistogramSeries>,
    left_histogram_series: Vec<PromqlHistogramSeries>,
...
pub(super) fn native_histogram_input_present<T>(series: &[T], stats: QueryStats) -> bool {
...
pub(super) fn evaluate_native_exponential_histogram_binary_vector_vector(
    expression: &PromqlBinaryExpression,
...
pub(super) fn evaluate_native_histogram_binary_bool_vector_vector(
    expression: &PromqlBinaryExpression,
    left_series: Vec<PromqlHistogramSeries>,
    right_series: Vec<PromqlHistogramSeries>,
    eval_time_ms: u64,
...
pub(super) fn evaluate_native_exponential_histogram_binary_bool_vector_vector(
    expression: &PromqlBinaryExpression,
    left_series: Vec<PromqlExponentialHistogramSeries>,
    right_series: Vec<PromqlExponentialHistogramSeries>,
    eval_time_ms: u64,
...
pub(super) fn evaluate_native_histogram_mixed_binary_vector_vector(
    expression: &PromqlBinaryExpression,
    left_series: Vec<PromqlHistogramSeries>,
    right_series: Vec<PromqlExponentialHistogramSeries>,
    eval_time_ms: u64,
...
pub(super) fn evaluate_native_exponential_histogram_mixed_binary_vector_vector(
    expression: &PromqlBinaryExpression,
    left_series: Vec<PromqlExponentialHistogramSeries>,
    right_series: Vec<PromqlHistogramSeries>,
    eval_time_ms: u64,
...
pub(super) fn evaluate_native_histogram_mixed_binary_bool_vector_vector(
    expression: &PromqlBinaryExpression,
    left_series: Vec<PromqlHistogramSeries>,
    right_series: Vec<PromqlExponentialHistogramSeries>,
    eval_time_ms: u64,
...
pub(super) fn evaluate_native_exponential_histogram_mixed_binary_bool_vector_vector(
    expression: &PromqlBinaryExpression,
    left_series: Vec<PromqlExponentialHistogramSeries>,
    right_series: Vec<PromqlHistogramSeries>,
    eval_time_ms: u64,
...
fn exponential_histogram_bucket_map_decreased(
    ...
    previous.iter().any(|(bucket, previous_count)| {
        current.get(bucket).copied().unwrap_or(0.0) < *previous_count
    })
}
