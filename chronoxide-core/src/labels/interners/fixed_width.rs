...
use super::super::{KeySetId, KeyValueRef, SeriesRef, SymbolId, U64HashMap};
use super::common::{LabelSetStore, LabelSetStoreError};
use super::keyset::{KeySetTable, SeriesEntry, ValueCodeDict};
use super::packing::{
    PackedKeySetBlock, PackedKeySetLabelSetStoreBufferStats, PackedKeySetStoreAccounting,
    estimate_packed_keyset_allocated_bytes, estimate_packed_keyset_used_bytes,
    packed_keyset_buffer_stats, shrink_packed_keyset_store, unpack_value_code,
};
...
pub struct FixedWidthPackedKeySetLabelSetStore<S: SymbolTable = DefaultSymbolTable> {
    ...
    pub(super) per_keyset_blocks: Vec<PackedKeySetBlock>,
...
impl<S: SymbolTable> FixedWidthPackedKeySetLabelSetStore<S> {
    ...
    fn accounting(&self) -> PackedKeySetStoreAccounting<'_, S, PackedKeySetBlock> {
