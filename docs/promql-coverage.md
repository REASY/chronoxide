...
- native histogram aggregation and bound edge cases, including `sum by (...)`
  ...
  classic/custom and exponential native histograms, invalid scalar/histogram and
...
histogram binary operator edge cases such as set operators and mixed
classic/exponential operands, native histogram error/drop cases beyond custom
