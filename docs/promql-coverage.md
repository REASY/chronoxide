...
- native histogram aggregation and bound edge cases, including `sum by (...)`
  ...
  and aggregated explicit-bound layouts, and `histogram_fraction(-Inf, Inf,
...
histogram/drop edge cases, native histogram error/drop cases beyond custom
