...
- native histogram aggregation and bound edge cases, including `sum by (...)`
  ...
  histogram sum/scalar arithmetic and scaled aggregation for both custom and
