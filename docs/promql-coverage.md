...
histogram binary operator edge cases such as additional comparison error/drop
shapes and vector matching combinations with stale or non-finite operands,
