...
histogram binary operator edge cases such as additional vector-matching
combinations for histogram comparisons and mixed representations, native
histogram error/drop cases beyond custom bucket coarsening, and deeper OTLP
