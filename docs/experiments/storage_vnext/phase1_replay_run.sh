...
BUILD_COMMAND="${BUILD_COMMAND:-cargo build --locked --release --no-default-features -p chronoxide-ingester -p chronoxide-query-cli --bin chronoxide-ingester --bin chronoxide-query --bin chronoxide-storage-verify}"
